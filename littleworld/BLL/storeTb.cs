...
namespace littleworld.BLL
{
	...
	{
		private readonly littleworld.DAL.storeTb dal=new littleworld.DAL.storeTb();
		public storeTb()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public littleworld.Model.storeTb GetModelByCache(int ID)
		{
			
			string CacheKey = "storeTbModel-" + ID;
			...
			return (littleworld.Model.storeTb)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<littleworld.Model.storeTb> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<littleworld.Model.storeTb> DataTableToList(DataTable dt)
		{
			List<littleworld.Model.storeTb> modelList = new List<littleworld.Model.storeTb>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				littleworld.Model.storeTb model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new littleworld.Model.storeTb();
