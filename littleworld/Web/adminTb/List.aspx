<%@ Page Title="adminTb" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="littleworld.Web.adminTb.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="adminEmail" HeaderText="adminEmail" SortExpression="adminEmail" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="adminLevel" HeaderText="adminLevel" SortExpression="adminLevel" ItemStyle-HorizontalAlign="Center"  /> 
