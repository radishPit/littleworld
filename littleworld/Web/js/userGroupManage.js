...
function getstarlist() {
    ...
    $("#workmatelist").click(function () {
    groupchose(2);
    });
    $("#classmatelist").click(function () {
    groupchose(3);
    });
...
function groupchose(groupid){
    ...
    $.ajax({
        url: "ws/userGroupManage.asmx/Grouplist",
        type: "POST",
        contentType: "application/json",
        data: "{sendID:5,groupID:'"+ groupid +"'}",
        dataType: "json",
...
function addInfo() {
    ...
    $.ajax({
        url: "ws/userGroupManage.asmx/Addinfo",
        type: "POST",
        contentType: "application/json",
        data: "{sendID:5}",
        dataType: "json",
